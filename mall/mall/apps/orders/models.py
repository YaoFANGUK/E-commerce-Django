...
class OrderInfo(BaseModel):
    ...
    freight = models.DecimalField(null=True, max_digits=10, decimal_places=2, verbose_name='运费')
...
class OrderGoods(BaseModel):
    ...
    is_commented = models.BooleanField(default=False, verbose_name="是否已经评价")
